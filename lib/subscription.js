...
// Human-readable labels for each gated feature, used in upgrade prompts.
export const FEATURE_LABELS = {
  seoBriefs: "SEO brief generator",
  citationFinder: "AI citation finder",
  competitorTracker: "Competitor GEO tracker",
  recommendedFixes: "Recommended GEO fixes",
  geoFix: "GEO Fix — generate content to close visibility gaps",
  emailAlerts: "Instant email & Slack alerts",
  whiteLabelReports: "White-label PDF reports",
...
// Formats a limit for display (Infinity -> "Unlimited").
